...
def parse_args():
    ...
    parser.add_argument("vec_name", nargs='?', default='embeddings.vec', help="Name of the embedding file to use")
    parser.add_argument("filtered_vec_name", nargs='?', default='embeddings_filtered.vec', help="Name of the filtered embedding file")
